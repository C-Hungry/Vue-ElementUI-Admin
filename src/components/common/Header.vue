<template>
  <div class="header">
    ...
    <div class="logo">温州竞学后端管理系统</div>
    <div class="header-right">
      <div class="header-user-con">
        <!-- 切换学科 -->
        <div class="btn-switch-subject" @click="handleSwitchSubject">
          <span class="label">切换学科</span>
          <el-dropdown placement="bottom" size="small">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>&#x3000;外语&#x3000;</el-dropdown-item>
